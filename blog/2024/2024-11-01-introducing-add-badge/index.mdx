...
We could handle circles or rectangles and the gravity logic would position the badge properly. We test drove a few of our client applications to confirm their specific logos worked and once we worked out a few edge cases we were happy with it.
