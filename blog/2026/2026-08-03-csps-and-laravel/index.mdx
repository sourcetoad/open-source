...
add_header Reporting-Endpoints 'csp-endpoint="${SENTRY_CSP_URL}"' always;
add_header Content-Security-Policy "${CSP_DEFAULT_SRC}; ${CSP_FONT_SRC}; ${CSP_FRAME_SRC}; report-to csp-endpoint;" always;
```
...
If a CSP violation was triggered it would display a Toast message instructing the user to check the console.

![Screenshot of a CSP violation toast notification](policy.png)
